    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            LoginViewEntity loginViewEntity = new LoginViewEntity
                    .Builder(LoginActivity.this, R.layout.fragment_login, R.id.et_url, R.id.et_user, R.id.et_pass, R.id.cb_save_info, R.id.btn_login, R.id.pbar_login, R.id.tv_title_appname, R.id.cl_frag_login)
