...
public class IntentIntegrator {
   ...
   */
  public AlertDialog initiateScan(Fragment fm) {
    return initiateScan(ALL_CODE_TYPES, fm);
  }
   ...
   */
  public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, Fragment fm) {
    ...
    fm.startActivityForResult(intentScan, REQUEST_CODE);
    return null;
  }
