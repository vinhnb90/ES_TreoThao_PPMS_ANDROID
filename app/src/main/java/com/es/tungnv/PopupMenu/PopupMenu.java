package com.es.tungnv.PopupMenu;
...
public class PopupMenu {
    ...
    public void show(View anchor) {
        ...
        mPopupWindow.showAtLocation(anchor, Gravity.CENTER, xPos, yPos);
    }
    ...
    public void setHeaderTitle(CharSequence title) {
        ...
        mHeaderTitleView.setBackgroundResource(R.drawable.title_unselected);
    }
