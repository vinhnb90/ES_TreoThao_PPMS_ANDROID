...
public class EsspSentBV implements Runnable {
    URL connectURL;
    FileInputStream fileInputStream = null;

    public EsspSentBV(String urlString) {
        try {
    ...
    String Sending(String iFileName, int HOSO_ID) {
        ...
        try {
            ...
            dos.writeBytes(lineEnd);
            dos.writeBytes(twoHyphens + boundary + lineEnd);
            dos.writeBytes("Content-Disposition: form-data; name=\"SO_DO\";filename=\"" + iFileName + "\"" + lineEnd);
            dos.writeBytes(lineEnd);
