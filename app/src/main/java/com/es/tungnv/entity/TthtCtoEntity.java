...
public class TthtCtoEntity {
    ...
    private int SOVIEN_CBOOC;
    private int LOAI_HOM;
    private String MA_SOCHOM;
    private int SOVIEN_CHOM;
    private int HS_NHAN;
    ...
    public int getSOVIEN_CBOOC() {
        return SOVIEN_CBOOC;
    }

    public void setSOVIEN_CBOOC(int SOVIEN_CBOOC) {
        this.SOVIEN_CBOOC = SOVIEN_CBOOC;
    }
    ...
    public int getSOVIEN_CHOM() {
        return SOVIEN_CHOM;
    }

    public void setSO_VIENCHOM(int SOVIEN_CHOM) {
    ...
    public String getTEN_ANH_CONG_TO() {
        return TEN_ANH_CONG_TO;
    }

    public void setTEN_ANH_CONG_TO(String TEN_ANH_CONG_TO) {
